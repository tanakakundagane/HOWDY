...
const SectionPlaceholder = ({
  ...
  return (
    <section
      id={id}
      className={`relative flex min-h-screen w-full items-center justify-center ${bgColor} px-6 py-24`}
    >
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h2 className={`mb-6 font-serif text-4xl md:text-6xl ${textColor}`}>
            {title}
          </h2>
          <p
            className={`max-w-xl text-lg font-light leading-relaxed opacity-70 ${textColor}`}
          >
            {subtitle}
          </p>
    ...
    <div className="bg-[#FAF9F6] selection:bg-amber-100 selection:text-amber-900 overflow-x-hidden w-full relative">
      ...
      <footer className="w-full bg-zinc-950 py-12 text-center text-zinc-500">
        <p className="font-serif text-sm">
          &copy; 2024 Salon Name. All rights reserved.
        </p>
      </footer>
    </div>
  );
